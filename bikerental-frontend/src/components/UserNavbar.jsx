...
export default function UserNavbar(){
    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg">
              ...
              <img src="/images/team_01.jpg" width={"25"} height={"25"} className="img-fluid" alt /><p> </p>
                <Link className="navbar-brand" to="/"><em></em><h2>Ride<em>Sync</em></h2>
                <h6>- Your Journey, Your Bike, Your Way. Let's ride together!</h6>
                </Link>
