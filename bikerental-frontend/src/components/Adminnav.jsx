...
const AdminNav = ()=>{
    ...
    <nav className="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <h5 className="text-center text-uppercase" style={{width: '100%'}}>Admin Panal</h5>
        {/* Right navbar links */}
  ...
  {/* Brand Logo */}
  <Link to="dashboard.jsx" className="brand-link">
    <img src="images/team_01.jpg" alt="Admin Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
